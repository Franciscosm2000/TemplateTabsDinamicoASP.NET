        ...
        5: [function (d, e, f) {
            ...
            var h = d("./handle-dom"),
                ...
                o = function () {
                    ...
                    for (a.innerHTML = l["default"]; a.firstChild;) b.body.appendChild(a.firstChild) // (i.default.targetContainer != null) ? document.getElementById(i.default.targetContainer).appendChild(a.firstChild) : b.body.appendChild(a.firstChild)
                },
                p = function w() {
        ...
        7: [function (a, b, c) {
            ...
            var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (a) {
                ...
                i = function (a) {
                    ...
                    if (a.targetContainer) {
                        $(a.targetContainer).css('position', 'relative')
                        $(a.targetContainer).append($(".sweet-overlay"))
                        $(a.targetContainer).append($(".sweet-alert"))
                    } else {
                        $('body').append($(".sweet-overlay"))
                        $('body').append($(".sweet-alert"))
                    }
